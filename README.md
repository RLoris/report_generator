...
- Add a prompt base on your needs in prompts/... or use the default one (prompts/prompt.txt)
- Run this script :
...
The raw report should be detailed enough and safe to use, the ai report quality depends on the model you use (tested with mistral, llama3.2, qwen2.5:32b locally), best default is already set, please verify the final output !
